...
type LeadStringBattleTactic struct {
	tacticsParams *model.TacticsParams
	triggerRate   float64
}

func (l LeadStringBattleTactic) Init(tacticsParams *model.TacticsParams) _interface.Tactics {
	l.tacticsParams = tacticsParams
	l.triggerRate = 1.0
	return l
}

func (l LeadStringBattleTactic) Prepare() {
...
func (l LeadStringBattleTactic) Id() consts.TacticId {
	return consts.LeadStringBattle
}

func (l LeadStringBattleTactic) Name() string {
	return "引弦力战"
}

func (l LeadStringBattleTactic) TacticsSource() consts.TacticsSource {
	return consts.TacticsSource_Event
}

func (l LeadStringBattleTactic) GetTriggerRate() float64 {
	return l.triggerRate
}

func (l LeadStringBattleTactic) SetTriggerRate(rate float64) {
	l.triggerRate = rate
}

func (l LeadStringBattleTactic) TacticsType() consts.TacticsType {
	return consts.TacticsType_Passive
}

func (l LeadStringBattleTactic) SupportArmTypes() []consts.ArmType {
	return []consts.ArmType{
		consts.ArmType_Archers,
	}
}

func (l LeadStringBattleTactic) Execute() {
