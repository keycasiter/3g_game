...
type WarBookDetailType_4 struct {
}

func (w *WarBookDetailType_4) Handle(ctx context.Context, general *vo.BattleGeneral, tacticParams *model.TacticsParams) {
	for i := 0; i < int(general.Addition.GeneralStarLevel); i++ {
		...
		util.BuffEffectWrapSet(ctx, general, consts.BuffEffectType_LaunchWeaponDamageImprove, &vo.EffectHolderParams{
			...
			FromWarbook:    consts.WarBookDetailType_4,
			EffectRate:     0.02,
		})
		//谋略伤害
