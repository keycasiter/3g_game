...
type BloodBladeBattleTactic struct {
	tacticsParams *model.TacticsParams
	triggerRate   float64
}

func (b BloodBladeBattleTactic) Init(tacticsParams *model.TacticsParams) _interface.Tactics {
	b.tacticsParams = tacticsParams
	b.triggerRate = 1.0
	return b
}

func (b BloodBladeBattleTactic) Prepare() {
...
func (b BloodBladeBattleTactic) Id() consts.TacticId {
	return consts.BloodBladeBattle
}

func (b BloodBladeBattleTactic) Name() string {
	return "血刃争锋"
}

func (b BloodBladeBattleTactic) TacticsSource() consts.TacticsSource {
	return consts.TacticsSource_Event
}

func (b BloodBladeBattleTactic) GetTriggerRate() float64 {
	return b.triggerRate
}

func (b BloodBladeBattleTactic) SetTriggerRate(rate float64) {
	b.triggerRate = rate
}

func (b BloodBladeBattleTactic) TacticsType() consts.TacticsType {
	return consts.TacticsType_Passive
}

func (b BloodBladeBattleTactic) SupportArmTypes() []consts.ArmType {
...
func (b BloodBladeBattleTactic) Execute() {
