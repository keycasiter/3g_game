...
// 用间
type WarBookDetailType_56 struct {
}

func (w *WarBookDetailType_56) Handle(ctx context.Context, general *vo.BattleGeneral, tacticParams *model.TacticsParams) {
	for i := 0; i < int(general.Addition.GeneralStarLevel); i++ {
		...
		util.BuffEffectWrapSet(ctx, general, consts.BuffEffectType_LaunchWeaponDamageImprove, &vo.EffectHolderParams{
			...
			FromWarbook:    consts.WarBookDetailType_56,
			EffectRate:     0.02,
		})
		//谋略伤害
