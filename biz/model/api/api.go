...
func (p *GeneralLotteryDoResponse) ReadField2(iprot thrift.TProtocol) error {
	...
	p.GeneralLotteryInfoList = make([]*GeneralLotteryDoInfo, 0, size)
	for i := 0; i < size; i++ {
		_elem := NewGeneralLotteryDoInfo()
		if err := _elem.Read(iprot); err != nil {
			return err
		}

		p.GeneralLotteryInfoList = append(p.GeneralLotteryInfoList, _elem)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return err
	}
...
func (p *GeneralLotteryDoInfo) ReadField1(iprot thrift.TProtocol) error {
	p.GeneralInfo = NewMetadataGeneral()
	if err := p.GeneralInfo.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *GeneralLotteryInfoQueryResponse) ReadField2(iprot thrift.TProtocol) error {
	...
	p.GeneralLotteryPoolInfoList = make([]*GeneralLotterInfoQueryInfo, 0, size)
	for i := 0; i < size; i++ {
		_elem := NewGeneralLotterInfoQueryInfo()
		if err := _elem.Read(iprot); err != nil {
			return err
		}

		p.GeneralLotteryPoolInfoList = append(p.GeneralLotteryPoolInfoList, _elem)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return err
	}
...
func (p *GeneralLotterInfoQueryInfo) ReadField1(iprot thrift.TProtocol) error {
	...
	p.GeneralInfoList = make([]*MetadataGeneral, 0, size)
	for i := 0; i < size; i++ {
		_elem := NewMetadataGeneral()
		if err := _elem.Read(iprot); err != nil {
			return err
		}

		p.GeneralInfoList = append(p.GeneralInfoList, _elem)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return err
	}
...
func (p *GeneralLotteryRateQueryResponse) ReadField2(iprot thrift.TProtocol) error {
	...
	p.GeneralLotteryRateInfoList = make([]*GeneralLotteryRateQueryInfo, 0, size)
	for i := 0; i < size; i++ {
		_elem := NewGeneralLotteryRateQueryInfo()
		if err := _elem.Read(iprot); err != nil {
			return err
		}

		p.GeneralLotteryRateInfoList = append(p.GeneralLotteryRateInfoList, _elem)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return err
	}
...
func (p *GeneralLotteryPoolQueryResponse) ReadField2(iprot thrift.TProtocol) error {
	...
	p.GeneralLotteryPoolInfoList = make([]*GeneralLotterPoolQueryInfo, 0, size)
	for i := 0; i < size; i++ {
		_elem := NewGeneralLotterPoolQueryInfo()
		if err := _elem.Read(iprot); err != nil {
			return err
		}
...
func (p *GeneralLotteryUserDataQueryResponse) ReadField2(iprot thrift.TProtocol) error {
	p.GeneralLotteryDataQueryInfo = NewGeneralLotteryUserDataQueryInfo()
	if err := p.GeneralLotteryDataQueryInfo.Read(iprot); err != nil {
		return err
	}
	return nil
}
...
func (p *ApiServiceGeneralLotteryPoolQueryArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Request = NewGeneralLotteryPoolQueryRequest()
	if err := p.Request.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ApiServiceGeneralLotteryPoolQueryResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewGeneralLotteryPoolQueryResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ApiServiceGeneralLotteryInfoQueryArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Request = NewGeneralLotteryInfoQueryRequest()
	if err := p.Request.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ApiServiceGeneralLotteryInfoQueryResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewGeneralLotteryInfoQueryResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ApiServiceGeneralLotteryRateQueryArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Request = NewGeneralLotteryRateQueryRequest()
	if err := p.Request.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ApiServiceGeneralLotteryRateQueryResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewGeneralLotteryRateQueryResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ApiServiceGeneralLotteryDoArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Request = NewGeneralLotteryDoRequest()
	if err := p.Request.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ApiServiceGeneralLotteryDoResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewGeneralLotteryDoResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ApiServiceGeneralLotteryUserDataResetArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Request = NewGeneralLotteryUserDataResetRequest()
	if err := p.Request.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ApiServiceGeneralLotteryUserDataResetResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewGeneralLotteryUserDataResetResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ApiServiceGeneralLotteryUserDataQueryArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Request = NewGeneralLotteryUserDataQueryRequest()
	if err := p.Request.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ApiServiceGeneralLotteryUserDataQueryResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewGeneralLotteryUserDataQueryResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ApiServiceUserInfoQueryArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Request = NewUserInfoQueryRequest()
	if err := p.Request.Read(iprot); err != nil {
		return err
	}
	return nil
...
func (p *ApiServiceUserInfoQueryResult) ReadField0(iprot thrift.TProtocol) error {
	p.Success = NewUserInfoQueryResponse()
	if err := p.Success.Read(iprot); err != nil {
		return err
	}
	return nil
