...
func (p *SpecialTechQueryRequest) GetLevel() (v enum.EquipLevel) {
	return p.Level
}
...
func (p *SpecialTechQueryRequest) ReadField4(iprot thrift.TProtocol) error {
...
func (p *SpecialTechQueryRequest) writeField4(oprot thrift.TProtocol) (err error) {
